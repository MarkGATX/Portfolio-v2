...
lib.ssMetadata = [
		{name:"coffee_cup_animate_sm_resp_atlas_1", frames: [[0,0,398,581],[0,583,367,241],[0,826,378,62],[0,890,420,18],[0,910,409,18]]}
];
...
(lib.Image = function() {
	this.initialize(ss["coffee_cup_animate_sm_resp_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.coffeecupanimationsm = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(39.75,124.3,0.14,0.14,0,0,0,238.7,408);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({regX:143.7,regY:209.6,rotation:4.198,x:28.5,y:95.6},0).wait(1).to({rotation:8.3784,x:30.65,y:94.95},0).wait(1).to({rotation:12.534,x:32.8,y:94.35},0).wait(1).to({rotation:16.6461,x:34.95,y:93.95},0).wait(1).to({rotation:20.5904,x:37.1,y:93.7},0).wait(1).to({rotation:22.518,x:38.1},0).wait(1).to({rotation:24.0538,x:38.9},0).wait(1).to({rotation:25.4358,x:39.65},0).wait(1).to({rotation:26.6775,x:40.3,y:93.75},0).wait(1).to({rotation:27.7548,x:40.9},0).wait(1).to({rotation:28.5979,x:41.35,y:93.85},0).wait(1).to({rotation:29,x:41.6},0).wait(1).to({rotation:28.1828,x:41.15},0).wait(1).to({rotation:26.0598,x:39.95},0).wait(1).to({rotation:22.942,x:38.3,y:93.9},0).wait(1).to({rotation:18.9956,x:36.2,y:94.15},0).wait(1).to({rotation:14.288,x:33.7,y:94.55},0).wait(1).to({rotation:8.7563,x:30.85,y:95.25},0).wait(1).to({rotation:1.1155,x:27,y:96.8},0).wait(1).to({rotation:-2.0978,x:25.4,y:97.05},0).wait(1).to({rotation:-3.5575,x:24.75,y:97},0).wait(1).to({rotation:-4.6659,x:24.25,y:96.85},0).wait(1).to({rotation:-5.5214,x:23.8,y:96.65},0).wait(1).to({rotation:-6,x:23.6,y:96.35},0).wait(1).to({rotation:-5.3165,x:23.9,y:96.7},0).wait(1).to({rotation:-3.8234,x:24.6,y:96.75},0).wait(1).to({rotation:-1.8688,x:25.55,y:96.8},0).wait(1).to({rotation:0.447,x:26.6},0).wait(1).to({rotation:1.6882,x:27.25,y:96.55},0).wait(1).to({rotation:2.8586,x:27.85,y:96.25},0).wait(1).to({rotation:3.9191,x:28.35,y:96},0).wait(1).to({rotation:4.6295,x:28.75,y:95.9},0).wait(1).to({rotation:3.7276,x:28.25,y:96.1},0).wait(1).to({rotation:2.1963,x:27.55,y:96.4},0).wait(1).to({rotation:0.405,x:26.65,y:96.85},0).wait(1).to({rotation:-1.4006,x:25.75,y:97},0).wait(1).to({rotation:-2.318,x:25.35,y:96.9},0).wait(1).to({rotation:-1.1629,x:25.85,y:96.95},0).wait(1).to({rotation:0.3875,x:26.6,y:96.85},0).wait(1).to({rotation:-0.3684,x:26.25},0).wait(1).to({rotation:-1.0965,x:25.9,y:96.9},0).wait(1).to({rotation:-0.4331,x:26.2},0).wait(1).to({rotation:0.3875,x:26.6,y:96.85},0).wait(1).to({rotation:0.3875},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1));
	...
	this.shape_3.graphics.f("#333349").s().p("AijA2QgpghAAguQAAguBQA0QBRA0AHgyQAGgyCMgEQCNgEhFAfQhEAeg9AYQg8AZg5AaQgZAMgWAAQgcAAgYgTg");
	...
	this.shape_14.graphics.f("#804E37").s().p("");
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"./public/images/coffee_cup_animate_sm_resp_atlas_1.png", id:"coffee_cup_animate_sm_resp_atlas_1"}
	],
	preloads: []
};
